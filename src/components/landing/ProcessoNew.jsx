...
const steps = [
  ...
  { num: "03", title: "Produzione", desc: "Componenti Octanorm certificati. Produzione in Italia o Lagos. Controllo qualità totale." },
  { num: "04", title: "Montaggio", desc: "Team dedicato on-site. Presenti per ogni necessità tecnica durante la fiera." },
];
...
export default function ProcessoNew() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden py-0 bg-[#0f0f10]">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-8 md:px-16 py-24">
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[9px] tracking-[0.35em] uppercase text-primary font-medium">Come lavoriamo</span>
            </div>
            <h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-0">
            {steps.map((s, i) => (
              ...
              >
                {/* Number big behind */}
                <div
                  className="font-display text-[80px] font-normal leading-none text-white/[0.04] group-hover:text-primary/[0.08] transition-colors duration-500 mb-4 select-none"
                >
                  {s.num}
                </div>
